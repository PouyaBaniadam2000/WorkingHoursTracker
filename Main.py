...
root = Tk()
root.title("Working Hours Tracker")
root.maxsize(width=475, height=550)
root.minsize(width=475, height=550)
root.iconbitmap(resource_path("clock.ico"))
...
def main_screen():
    ...
    def arrive():
        ...
        bg = ImageTk.PhotoImage(Image.open(resource_path(f"{all_rows[0]['ThemeColor']}.png")))
        bg_abel = Label(image=bg)
        bg_abel.place(x=-6, y=-2)

        button_arrive = PhotoImage(file=resource_path(f"{all_rows[0]['ArriveBtn']}.png"))
        ...
        button_break = PhotoImage(file=resource_path(f"{all_rows[0]['BreakBtn']}.png"))
        ...
        button_leave = PhotoImage(file=resource_path(f"{all_rows[0]['LeaveBtn']}.png"))
    ...
    def leave():
        ...
        def sure_to_leave():
            ...
            if all_rows[0]["ThemeColor"] == "rest_bg":
                ...
                if all_rows[-1]["date"] == "Y/M/D":
                    ...
                    bg = ImageTk.PhotoImage(Image.open(resource_path(f"added_bg.png")))
                    bg_abel = Label(image=bg)
                    bg_abel.place(x=-6, y=-2)

                    button_exit = PhotoImage(file=resource_path(f"exit_all_clear.png"))
                    ...
                    button_home = PhotoImage(file=resource_path(f"home_all_clear.png"))
                    ...
                    if arrived_date in all_date_list:
                        ...
                        bg = ImageTk.PhotoImage(Image.open(resource_path(f"wrong_bg.png")))
                        bg_abel = Label(image=bg)
                        bg_abel.place(x=-6, y=-2)

                        button_exit = PhotoImage(file=resource_path(f"exit_sth_wrong.png"))
                        button_exit_label = Label(image=button_exit, bg="#242424")
                        button_exit_label.place(x=300, y=440)
                        real_button_exit = Button(root, image=button_exit, borderwidth=0, bg="#242424",
                                                  activebackground="#242424", command=destroy)
                        ...
                        button_home = PhotoImage(file=resource_path(f"home_sth_wrong.png"))
                        button_home_label = Label(image=button_home, bg="#242424")
                        button_home_label.place(x=40, y=440)
                        real_button_home = Button(root, image=button_home, borderwidth=0, bg="#242424",
                                                  activebackground="#242424", command=main_screen)
        ...
        def change():
            ...
            bg = ImageTk.PhotoImage(Image.open(resource_path(f"change_bg.png")))
            bg_abel = Label(image=bg)
            bg_abel.place(x=-6, y=-2)

            button_mines = PhotoImage(file=resource_path(f"mines_btn.png"))
            ...
            button_plus = PhotoImage(file=resource_path(f"plus_btn.png"))
            ...
            button_submit = PhotoImage(file=resource_path(f"submit_btn.png"))
            ...
            current_arrive_time_label = Label(root, text=all_rows[0]['Arrived'], font=("Lucida Calligraphy", 22),
                                              bg="#4B4B4B", foreground="#ffffff")
            current_arrive_time_label.place(x=175, y=250)

            how_much_to_add_to_arrive_entry = Entry(root, borderwidth=0, font=("Lucida Calligraphy", 22), bg="#4B4B4B",
                                                    foreground="#ffffff")
        ...
        bg = ImageTk.PhotoImage(Image.open(resource_path(f"leave_bg.png")))
        bg_abel = Label(image=bg)
        bg_abel.place(x=-6, y=-2)

        button_yes = PhotoImage(file=resource_path(f"yes_btn.png"))
        ...
        button_no = PhotoImage(file=resource_path(f"no_btn.png"))
        ...
        button_change = PhotoImage(file=resource_path(f"change_btn.png"))
